...
public class Cafe {
   ...
   public static String find_type(Cafe esql) throws SQLException{
   ...
   public static void EmployeeUpdateOrder(Cafe esql) throws IOException, SQLException{
     
      
      System.out.print("\tEnter the OrderID: ");
      String orderid = in.readLine();
      System.out.print("\t1) Change this order to paid   2) Change the status of items: ");
      ...
      if(choice.equals("1")){
    	  ...
    	  esql.executeUpdate(query);
    	  System.out.print("\tChanged to paid");
    	  return;
      }else if(choice.equals("2")){
    	  System.out.print("\tInput the item name: ");
    	  String itemName= in.readLine();
    	  System.out.print("\tInput the new status: ");
    	  String newStatus= in.readLine();
    	  
    	  String query = String.format("UPDATE ItemStatus SET status = %s WHERE orderid = %s "
    	  		+ "AND itemName = %s", newStatus, orderid, itemName);
    	  esql.executeUpdate(query);
    	  System.out.print("\tItem status changed!!");
    	  return;    	  
      }
   ...
   public static void ViewOrderHistory(Cafe esql) throws IOException, SQLException{
      // Your code goes here.
	   if( (authorisedUser.equals("Employee")) || (authorisedUser.equals("Manager")) ){
		   System.out.print("\t1) : See all orders within 24 hours 2) Browse the order history: ");
		   String choice = in.readLine();
		   if(choice.equals("1")){
			   String query = String.format("SELECT timeStampRecieved FROM Orders "
			   		+ "WHERE timeStampRecieved > (CURRENT_DATE - INTERVAL '1 day')");
			   esql.executeQueryAndPrintResult(query);
			   return;
		   }
	   }
	   
	   String query = String.format("SELECT * FROM Orders ORDER BY timeStampRecieved DESC LIMIT 5");
	   esql.executeQueryAndPrintResult(query);
   ...
   public static void UpdateUserInfo(Cafe esql){
      try{
         //System.out.print("\tEnter user login: ");
         //String login = in.readLine();
         System.out.print("\tEnter and update your password: ");
         String password = in.readLine();
         System.out.print("\tEnter and update your phone: ");
         String phone = in.readLine();
         
	 //String type="Customer";
         System.out.print("\tEnter and update your favorite item: ");
	 String favItems = in.readLine();
         //UPDATE Customers SET ContactName='Juan', City='Frankfurt' WHERE Country='Mexico';
	 String query = String.format("UPDATE USERS SET phoneNum ='%s', password ='%s', favItems ='%s' WHERE login = '%s'", phone, password, favItems, authorisedUser);
   ...
   public static void ManagerUpdateUserInfo(Cafe esql) throws IOException, SQLException{
       //
         System.out.print("\tEnter the login of the user you want to update: ");
         String login = in.readLine();

         System.out.print("\tEnter and update this user's type: ");
         String type = in.readLine();	
         System.out.print("\tEnter and update this user's password: ");
         String password = in.readLine();
         System.out.print("\tEnter and update this user's phone: ");
         String phone = in.readLine(); 
         System.out.print("\tEnter and update this user's favorite item: ");
	 String favItems = in.readLine();
         //UPDATE Customers SET ContactName='Juan', City='Frankfurt' WHERE Country='Mexico';
	 String query = String.format("UPDATE USERS SET type = '%s', phoneNum ='%s', password ='%s', favItems ='%s' WHERE login = '%s'", type, phone, password, favItems, login);

         esql.executeUpdate(query);
         System.out.println ("The User "+login+" successfully updated!");
   }//end
   
   public static void UpdateMenu(Cafe esql){}

   public static void ViewOrderStatus(Cafe esql) throws IOException, SQLException{
      // Your code goes here.
	   System.out.print("\tEnter the OrderID: ");
	   String orderid = in.readLine();
   ...
   public static void ViewCurrentOrder(Cafe esql) throws IOException, SQLException{
	   // Your code goes here.
	   String userType = find_type(esql);
           System.out.println(userType);
	   if( (userType.equals("Employee")) || (userType.equals("Manager ")) ){
		   System.out.print("\t1) : See all orders within 24 hours 2) Browse the order history: ");
		   String choice = in.readLine();
		   if(choice.equals("1")){
			   String query = String.format("SELECT timeStampRecieved FROM Orders "
